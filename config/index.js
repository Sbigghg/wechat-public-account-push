export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxacdcad54822b1b38",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "c76086e02ce2e6086811e34c9afebbce",
  ...
  USERS: [
    {
      ...
      name: "恒",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ok7Dp6TCEWb6ocxKa6OG3p_wPOo8",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "xVqOXiARk5nlySSWyY7eYCN_zr_IORH5MhiXxj4KI-4",
      // 所在省份
      province: "河南",
      // 所在城市
      city: "新乡",
